...
# === ENEMY SYSTEM ===
# Enemy types
# const ENEMY_TYPE_STALKER: String = "stalker"  # STALKER REMOVED
const ENEMY_TYPE_WATCHER: String = "watcher"
const ENEMY_TYPE_EFFIGY: String = "effigy"

# Enemy spawn cooldowns (seconds)
# const ENEMY_SPAWN_COOLDOWN_STALKER: float = 30.0  # STALKER REMOVED
...
const EFFIGY_STAGE_SANITY_THRESHOLDS: Array[int] = [80, 60, 40, 0] # Fixed thresholds to match requirements
